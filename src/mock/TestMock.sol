...
contract TestMock is NitroProver {
    ...
    function t_processAttestationDoc(
    ...
    function t_parseTbs(bytes memory certificate, uint256 ptr) external view {
